...
filedir   = os.path.join(base_dir, 'ACMI2026_Mar')
reportdir = os.path.join(filedir, 'Report')

fratio    = os.path.join(filedir, 'Results', 'acmi_ratio.raw')
facmi     = os.path.join(filedir, 'Results', 'posacmi.raw')
fnegative = os.path.join(filedir, 'Results', 'negacmi.raw')
fverify   = os.path.join(filedir, 'Results', 'verifyacmi.txt')

freport   = os.path.join(reportdir, 'acmi_cal2026_report.pdf')
...
t1=Table(tdata,0.8*inch,rowHeights=rowH,style=[
                ...
                ('SPAN',(0,20),(4,20)),
                ('BACKGROUND',(0,20),(4,20),colors.lemonchiffon),
                ('SPAN',(0,21),(4,21)),
                ('BACKGROUND',(0,21),(4,21),colors.lemonchiffon),
                ('BACKGROUND',(0,1),(0,19),colors.lightblue),
                ('GRID',(0,0),(-1,-1),0.5,colors.black),
                ('BOX',(0,0),(-1,-1),2,colors.black),
                ('LINEABOVE',(0,1),(4,1),2,colors.black),
                ('LINEABOVE',(0,2),(4,2),2,colors.black),
                ('LINEABOVE',(0,20),(4,20),2,colors.black),
                ('LINEABOVE',(0,21),(4,21),2,colors.black),
                ('LINEBEFORE',(1,1),(1,19),2,colors.black),
                ])
...
plt.savefig(reportdir + "/ICTRatio.png")

f = open(reportdir + "/ICTRatio.png",'rb')
...
plt.savefig(reportdir + "/ICTRatioVsVpulse.png")

f = open(reportdir + "/ICTRatioVsVpulse.png",'rb')
...
plt.tight_layout()
plt.savefig(reportdir + "/Positive1.png")
f = open(reportdir + "/Positive1.png",'rb')
elements.append(Image(f,width=5*inch, height=5*inch))
...
plt.tight_layout()
plt.savefig(reportdir + "/Positive2.png")
f = open(reportdir + "/Positive2.png",'rb')
...
ax.legend(loc='lower right')
plt.tight_layout()
plt.savefig(reportdir + "/Negative3.png")
sleep(1)
elements.append(Image(reportdir + "/Negative3.png",width=5*inch, height=5*inch))
...
plt.tight_layout()
plt.savefig(reportdir + "/Negative4.png")
elements.append(Image(reportdir + "/Negative4.png",width=7*inch, height=4*inch))
elements.append(PageBreak())
...
ax.text(0.05, 0.95, 'PASS / FAIL Test:\nADCA Saturated for 3\nLargest Charges ? '+result,
    transform=ax.transAxes, fontsize=10,verticalalignment='top', bbox=props)
plt.tight_layout()
plt.savefig(reportdir + "/Negative1.png")
elements.append(Image(reportdir + "/Negative1.png",width=5*inch, height=5*inch))
...
ax[1].text(0.05, 0.95, 'PASS / FAIL Test:\nADCB Saturated for 3\nlargest Charges ? '+result,
    transform=ax[1].transAxes, fontsize=10,verticalalignment='top', bbox=props)
plt.tight_layout()
plt.savefig(reportdir + "/Negative2.png")
elements.append(Image(reportdir + "/Negative2.png",width=7*inch, height=4*inch))
elements.append(PageBreak())
...
plt.tight_layout()
plt.savefig(reportdir + "/Negative4.png")
f = open(reportdir + "/Negative4.png",'rb')
elements.append(Image(f,width=7*inch, height=4*inch))
elements.append(PageBreak())
...
ax.text(0.4, 0.1, 'RMS Error < 0.200 ? '+result,
    transform=ax.transAxes, fontsize=10,verticalalignment='top', bbox=props)
plt.savefig(reportdir + "/Verify1.png")
f = open(reportdir + "/Verify1.png",'rb')
elements.append(Image(f,width=5*inch, height=5*inch))
...
ax.text(0.4, 0.1, 'RMS Error < 0.200 ? '+result,
    transform=ax.transAxes, fontsize=10,verticalalignment='top', bbox=props)
plt.savefig(reportdir + "/Verify2.png")
f = open(reportdir + "/Verify2.png",'rb')
elements.append(Image(f,width=5*inch, height=5*inch))
elements.append(PageBreak())
...
ax.text(0.4, 0.1, 'RMS Error < 0.200 ? '+result,
    transform=ax.transAxes, fontsize=10,verticalalignment='top', bbox=props)
plt.savefig(reportdir + "/Verify3.png")
f = open(reportdir + "/Verify3.png",'rb')
elements.append(Image(f,width=5*inch, height=5*inch))
...
plt.savefig(reportdir + "/Verify4.png")
f = open(reportdir + "/Verify4.png",'rb')
elements.append(Image(f,width=5*inch, height=5*inch))
elements.append(PageBreak())
